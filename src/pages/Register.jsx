    ...
    return (
        <div>
            <div className="hero my-10">
                <div className="hero-content grid grid-cols-1 md:grid-cols-2 justify-between gap-12">
                        ...
                        <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
                            ...
                            <form onSubmit={handelRegister} noValidate="" action="" className="space-y-6">
                                <div className="space-y-1 text-sm">
                                    ...
                                    <input type="text" name="name"  placeholder="Name" className="w-full px-4 py-3 rounded-md border outline-0" />
                                </div>
                                <div className="space-y-1 text-sm">
                                ...
                                <button className="block w-full p-3 text-center rounded-sm bg-red-500 text-white">Register</button>
                            </form>
